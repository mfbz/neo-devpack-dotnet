...
using System;
using System.Text;
using Array = Neo.SymVM.Types.Array;
...
namespace Neo.SymVM
{
    ...
    public class VMUnhandledException : Exception
    {
        ...
        /// </summary>
        public SymStackItem ExceptionObject { get; }
        ...
        public VMUnhandledException(SymStackItem ex) : base(GetExceptionMessage(ex))
        {
            ExceptionObject = ex;
        }

        private static string GetExceptionMessage(SymStackItem e)
        {
