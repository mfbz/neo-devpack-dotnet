...
namespace Neo.SymVM
{
    ...
    public partial class JumpTable
    {
        ...
        public virtual void Nop(SymEngine engine, SymInstruction instruction)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Jmp(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The instruction containing the offset as the first operand.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Jmp_L(SymEngine engine, SymInstruction instruction)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpIf(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 1, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpIf_L(SymEngine engine, SymInstruction instruction)
        {
            if (engine.Pop().GetBoolean())
                ExecuteJumpOffset(engine, instruction.TokenI32);
        }
        ...
        /// <remarks>Pop 1, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpIfNot(SymEngine engine, SymInstruction instruction)
        {
            if (!engine.Pop().GetBoolean())
                ExecuteJumpOffset(engine, instruction.TokenI8);
        }
        ...
        /// <remarks>Pop 1, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpIfNot_L(SymEngine engine, SymInstruction instruction)
        {
            if (!engine.Pop().GetBoolean())
                ExecuteJumpOffset(engine, instruction.TokenI32);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpEq(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpEq_L(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 == x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpNe(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 != x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpNe_L(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 != x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpGt(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 > x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpGt_L(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 > x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpGe(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 >= x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpGe_L(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 >= x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpLt(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 < x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpLt_L(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 < x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpLe(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 <= x2)
        ...
        /// <remarks>Pop 2, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void JmpLe_L(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            if (x1 <= x2)
        ...
        /// <param name="instruction">The instruction containing the offset as the first operand.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Call(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The instruction containing the offset as the first operand.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Call_L(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 1, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void CallA(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void CallT(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Abort(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 1, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Assert(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 1, Push 0</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Throw(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Try(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Try_L(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void EndTry(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void EndTry_L(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void EndFinally(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Ret(SymEngine engine, SymInstruction instruction)
        {
            var context_pop = engine.InvocationStack.Pop();
            var stack_eval = engine.InvocationStack.Count == 0 ? engine.ResultStack : engine.InvocationStack.Peek().SymEvalStack;
            if (context_pop.SymEvalStack != stack_eval)
            {
                if (context_pop.RVCount >= 0 && context_pop.SymEvalStack.Count != context_pop.RVCount)
                    ...
                    throw new InvalidOperationException($"Return value count mismatch: expected {context_pop.RVCount}, but got {context_pop.SymEvalStack.Count} items on the evaluation stack");
                context_pop.SymEvalStack.CopyTo(stack_eval);
            }
        ...
        /// <param name="instruction">The current instruction.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Syscall(SymEngine engine, SymInstruction instruction)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ExecuteCall(SymEngine engine, int position)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ExecuteEndTry(SymEngine engine, int endOffset)
        {
            if (engine.CurrentContext!.TryStack is null)
                throw new InvalidOperationException($"The corresponding TRY block cannot be found.");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ExecuteJump(SymEngine engine, int position)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ExecuteJumpOffset(SymEngine engine, int offset)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ExecuteTry(SymEngine engine, int catchOffset, int finallyOffset)
        {
        ...
        public virtual void ExecuteThrow(SymEngine engine, SymStackItem? ex)
        {
