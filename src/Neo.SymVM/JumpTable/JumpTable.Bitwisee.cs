...
namespace Neo.SymVM
{
    ...
    public partial class JumpTable
    {
        ...
        public virtual void Invert(SymEngine engine, SymInstruction instruction)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void And(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Or(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 | x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void XOr(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 ^ x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Equal(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop();
            var x1 = engine.Pop();
            engine.Push(x1.Equals(x2));
        }
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void NotEqual(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop();
            var x1 = engine.Pop();
            engine.Push(!x1.Equals(x2));
