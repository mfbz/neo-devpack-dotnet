...
namespace Neo.SymVM
{
    ...
    public partial class JumpTable
    {
        ...
        public virtual void IsNull(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop();
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void IsType(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop();
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Convert(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void AbortMsg(SymEngine engine, SymInstruction instruction)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void AssertMsg(SymEngine engine, SymInstruction instruction)
        {
            var msg = engine.Pop().GetString();
