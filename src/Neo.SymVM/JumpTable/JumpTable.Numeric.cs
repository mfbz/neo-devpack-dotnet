...
namespace Neo.SymVM
{
    ...
    public partial class JumpTable
    {
        ...
        public virtual void Sign(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Abs(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop().GetInteger();
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Negate(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop().GetInteger();
            engine.Push(-x);
        }
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Inc(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop().GetInteger();
            engine.Push(x + 1);
        }
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Dec(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop().GetInteger();
            engine.Push(x - 1);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Add(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Sub(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 - x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Mul(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 * x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Div(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 / x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Mod(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 % x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Pow(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Sqrt(SymEngine engine, SymInstruction instruction)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ModMul(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 3, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void ModPow(SymEngine engine, SymInstruction instruction)
        {
            var modulus = engine.Pop().GetInteger();
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Shl(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Shr(SymEngine engine, SymInstruction instruction)
        {
            var shift = (int)engine.Pop().GetInteger();
            if (shift == 0) return;
            var x = engine.Pop().GetInteger();
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Not(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void BoolAnd(SymEngine engine, SymInstruction instruction)
        {
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void BoolOr(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetBoolean();
            var x1 = engine.Pop().GetBoolean();
            engine.Push(x1 || x2);
        ...
        /// <remarks>Pop 1, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Nz(SymEngine engine, SymInstruction instruction)
        {
            var x = engine.Pop().GetInteger();
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void NumEqual(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 == x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void NumNotEqual(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
            engine.Push(x1 != x2);
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Lt(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop();
            var x1 = engine.Pop();
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Le(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop();
            var x1 = engine.Pop();
            if (x1.IsNull || x2.IsNull)
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Gt(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop();
            var x1 = engine.Pop();
            if (x1.IsNull || x2.IsNull)
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Ge(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop();
            var x1 = engine.Pop();
            if (x1.IsNull || x2.IsNull)
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Min(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
        ...
        /// <remarks>Pop 2, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Max(SymEngine engine, SymInstruction instruction)
        {
            var x2 = engine.Pop().GetInteger();
            var x1 = engine.Pop().GetInteger();
        ...
        /// <remarks>Pop 3, Push 1</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual void Within(SymEngine engine, SymInstruction instruction)
        {
