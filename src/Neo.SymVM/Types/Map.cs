...
namespace Neo.SymVM.Types
{
    ...
    /// </summary>
    public class Map : CompoundType, IReadOnlyDictionary<PrimitiveType, SymStackItem>
    {
        /// <summary>
        ...
        private readonly OrderedDictionary<PrimitiveType, SymStackItem> dictionary = new OrderedDictionary<PrimitiveType, SymStackItem>();
        ...
        public SymStackItem this[PrimitiveType key]
        {
            get
            {
        ...
        public override IEnumerable<SymStackItem> SubItems => Keys.Concat(Values);
        ...
        /// </summary>
        public IEnumerable<SymStackItem> Values => dictionary.Values;
        ...
        internal override SymStackItem DeepCopy(Dictionary<SymStackItem, SymStackItem> refMap, bool asImmutable)
        {
        ...
        IEnumerator<KeyValuePair<PrimitiveType, SymStackItem>> IEnumerable<KeyValuePair<PrimitiveType, SymStackItem>>.GetEnumerator()
        {
            return ((IDictionary<PrimitiveType, SymStackItem>)dictionary).GetEnumerator();
        }
        ...
        public bool Remove(PrimitiveType key)
        {
            if (key.Size > MaxKeySize)
                throw new ArgumentException($"MaxKeySize exceed: {key.Size}");
            if (IsReadOnly) throw new InvalidOperationException("The object is readonly.");
            if (!dictionary.Remove(key, out SymStackItem? old_value))
                return false;
            return true;
        }
...
#pragma warning disable CS8767
        public bool TryGetValue(PrimitiveType key, [MaybeNullWhen(false)] out SymStackItem value)
